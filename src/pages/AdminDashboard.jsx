        ...
        <main className="min-h-screen bg-[#F8FAFC] flex text-[#1E293B] font-sans">
            ...
            <aside className="w-[280px] bg-[#0F172A] text-slate-400 flex flex-col justify-between border-r border-slate-800 shrink-0 sticky top-0 h-screen z-40">
                <div className="p-6 flex flex-col h-full justify-between">
                    <div>
                        ...
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                ...
                                <span className="text-[9px] font-bold text-slate-500 uppercase tracking-widest">Operations Center</span>
                            </div>
                        </div>
                        ...
                        <nav className="space-y-1 max-h-[calc(100vh-220px)] overflow-y-auto pr-1">
                            {[
                                ...
                                <button
                                    ...
                                    className={`w-full flex items-center px-4 py-2.5 rounded-xl text-[11px] font-black tracking-wider uppercase transition-all text-left ${
                                        activeTab === item.id
                    ...
                    <div className="p-4 rounded-xl bg-slate-950/40 border border-slate-800 flex items-center justify-between gap-3 mt-4">
